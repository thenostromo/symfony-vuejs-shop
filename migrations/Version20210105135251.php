 ...
 */
final class Version20210105135251 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD rating NUMERIC(3, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD size INT DEFAULT NULL');
    }
