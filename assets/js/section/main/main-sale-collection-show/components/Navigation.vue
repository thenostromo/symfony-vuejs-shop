...
export default {
  computed: {
    ...mapState('saleCollection', ['page']),
    ...mapGetters("saleCollection", ["pagesCount"]),
    showPrevPageBtn() {
      return this.page !== 1 && (this.page <= this.pagesCount);
    }
  },
  methods: {
    ...mapActions("saleCollection", ["getProductsBySaleCollection"]),
    ...mapMutations("saleCollection", ["setPage"]),
