 ...
 *       "post"={
 *          "normalization_context"={"groups"="cart:write"},
 *       },
 *     "get"={
...
class Cart
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CartProduct::class, mappedBy="cart", cascade={"persist"}, orphanRemoval=true)
     *
     * @Groups({"cart:list", "cart:item", "cart:write"})
     */
